...
public interface CustomerService {
	...
	void mergeWithExistingAndUpdateOrCreate (CustomerForm customerForm, Errors errors, boolean createAccount) throws IllegalAccessException, InvocationTargetException;
